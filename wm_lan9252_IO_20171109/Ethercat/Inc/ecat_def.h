...
/** 
STM32F405_HW: Shall be set if the Slave code is executed on the PIC mounted on the EL9800 EtherCAT Evaluation Board.<br>
...
#ifndef STM32F405_HW
#define STM32F405_HW                                 1 //This define was already evaluated by ET9300 Project Handler(V. 1.3.3.0)!
#endif
...
/** 
STM32F405_APPLICATION: Should be set if the Slave Sample Code runs on an EL9800_x Evaluation Board. */
#ifndef STM32F405_APPLICATION
#define STM32F405_APPLICATION                   1//This define was already evaluated by ET9300 Project Handler(V. 1.3.3.0)!
#endif
...
#ifndef PRODUCT_CODE  
#define PRODUCT_CODE               		0x92521000
#endif
...
#define DEVICE_NAME_LEN              	0xA      //  0x14
#endif
...
#define MIN_PD_CYCLE_TIME              	0x186A0	//100us
